...
;(function (NB) {
  ...
  NB.register('segmented', function (el) {
    var indicator = el.querySelector('.nb-segmented__indicator');
    var items     = NB.$$('.nb-segmented__item', el);
    ...
    var active = el.querySelector('.nb-segmented__item.is-active');
    if (active) {
    ...
    NB.on(window, 'resize', function () {
      ...
      resizeTimer = setTimeout(function () {
        var current = el.querySelector('.nb-segmented__item.is-active');
